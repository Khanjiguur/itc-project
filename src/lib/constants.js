...
export const NOMINATIONS = [
    {
        id: 'best_leader',
        name: 'Шилдэг Удирдагч',
        emoji: '👑',
        description: 'Хамгийн сайн удирддаг, урамшуулдаг хүн',
        theme: {
            primary: '#d97706',
            secondary: '#f59e0b',
            accent: '#92400e',
    ...
    },
    {
        ...
        emoji: '🤝',
        description: 'Хамт олондоо хамгийн их хувь нэмэр оруулдаг',
        theme: {
            primary: '#059669',
            secondary: '#10b981',
            accent: '#065f46',
            ...
            bg: 'linear-gradient(145deg, #ecfdf5 0%, #d1fae5 60%, #a7f3d0 100%)',
            pageBg: '#ecfdf5',
            cardBg: '#ffffff',
            cardBorder: '#6ee7b7',
    ...
    },
    {
        ...
        name: 'Шинэлэг Санаа',
        emoji: '💡',
        description: 'Хамгийн бүтээлч, шинэлэг санаатай хүн',
        theme: {
            primary: '#7c3aed',
            secondary: '#8b5cf6',
            accent: '#4c1d95',
            ...
            bg: 'linear-gradient(145deg, #f5f3ff 0%, #ede9fe 60%, #ddd6fe 100%)',
            pageBg: '#f5f3ff',
            cardBg: '#ffffff',
            cardBorder: '#c4b5fd',
    ...
    },
    {
        ...
        name: 'Эерэг Хандлага',
        emoji: '🌟',
        description: 'Хамгийн эерэг, урам зориг өгдөг хүн',
        theme: {
            primary: '#e11d48',
            secondary: '#f43f5e',
            accent: '#9f1239',
            ...
            bg: 'linear-gradient(145deg, #fff1f2 0%, #ffe4e6 60%, #fecdd3 100%)',
            pageBg: '#fff1f2',
            cardBg: '#ffffff',
            cardBorder: '#fda4af',
            cardShadow: 'rgba(225, 29, 72, 0.18)',
            particle: '#f43f5e',
            buttonBg: 'linear-gradient(135deg, #f43f5e, #e11d48)',
            buttonText: '#ffffff',
    ...
    {
        id: 'hidden_gem',
        name: 'Нуугдмал Авьяас',
        emoji: '💎',
        description: 'Харагдаагүй ч гайхамшигтай авьяастай хүн',
        theme: {
            primary: '#0891b2',
            secondary: '#06b6d4',
            accent: '#164e63',
            ...
            bg: 'linear-gradient(145deg, #ecfeff 0%, #cffafe 60%, #a5f3fc 100%)',
            pageBg: '#ecfeff',
            cardBg: '#ffffff',
            cardBorder: '#67e8f9',
...
export const EMPLOYEES = [
    { id: 'emp001', name: 'Бат-Эрдэнэ Дорж', email: 'bat-erdene.dorj@itc.mn', gender: 'm' },
    { id: 'emp002', name: 'Оюунцэцэг Ганбаатар', email: 'oyuuntsetseg.ganbaatar@itc.mn', gender: 'f' },
    { id: 'emp003', name: 'Энхбаяр Мөнхбаяр', email: 'enkhbayar.munkhbayar@itc.mn', gender: 'm' },
    { id: 'emp004', name: 'Солонго Болд', email: 'solongo.bold@itc.mn', gender: 'f' },
